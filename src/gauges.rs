...
// use xandeum_client::rpc_config::RpcBlockConfig;
use solana_client::rpc_config::RpcBlockConfig;
// use xandeum_client::rpc_response::{RpcContactInfo, RpcVoteAccountInfo, RpcVoteAccountStatus};
    ...
    pub fn new(vote_accounts_whitelist: Whitelist) -> Self {
        Self {
            ...
            node_versions: register_int_gauge_vec!(
                "xandeum_node_versions",
                "Count of node versions",
                &["version"]
            )
            .unwrap(),
            nodes: register_int_gauge!("xandeum_nodes", "Number of nodes").unwrap(),
            average_slot_time: register_gauge!("xandeum_average_slot_time", "Average slot time")
                .unwrap(),
